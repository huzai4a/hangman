...
public class V7
{
    ...
    public static void main(String[] args) {
        ...
        fillarrays(worddash, alpharay, alphabet);//calls fill arrays
    ...
    public static void fillarrays (char [] tempar1, char [] tempar2, String alphatemp) {
